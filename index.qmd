...
The data used for this analysis comes in part from the r `gapminder` package, and is originally sourced from the Gapminder Foundation. Additionally, population data from the World Bank was used.
